...
public class LibraryEdit extends JFrame implements Login {
    JPanel main;
    String data;
    public LibraryEdit(String data) {
        this.data=data;
    ...
    private void getEditPanel() {
        JPanel editPanel=new Book().getBookPanel(data,this,true);
        editPanel.setBounds(10, 10, 820, 620);
        System.out.println("Bhushan"+data);
        main.removeAll();
        main.repaint();
        main.revalidate();
        main.add(editPanel);
